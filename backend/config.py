...
_has_service_account = bool(GOOGLE_SERVICE_ACCOUNT_JSON_CONTENT or GOOGLE_SERVICE_ACCOUNT_JSON)
_has_oauth = bool(GOOGLE_OAUTH_REFRESH_TOKEN and GOOGLE_OAUTH_CLIENT_ID and GOOGLE_OAUTH_CLIENT_SECRET)

GOOGLE_SYNC_ENABLED = bool(
    (_has_service_account or _has_oauth)
