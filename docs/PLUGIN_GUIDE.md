...
**관련 문서:**
- [베타 테스트 가이드](BETA_TESTING.md) - 베타 테스트에 대한 상세 가이드
...
베타 테스트에 대한 자세한 내용은 별도 문서를 참고하세요:

📖 **[베타 테스트 가이드](BETA_TESTING.md)** - 베타 테스트 계획, 테스터 선정, 피드백 수집 방법 등
...
이 프로젝트는 **All Rights Reserved** 라이선스를 적용하고 있습니다.

### 라이선스 정보

- **라이선스**: All Rights Reserved (저작권 보유)
- **저작권자**: Jongwook Kim, Jangho Park
- **연락처**: johnwkim82@gmail.com or jpzawakun@gmail.com
- **용도**: 개별 연구 프로젝트용
...
프로젝트 루트에 `LICENSE` 파일이 생성되어 있습니다:

```
Copyright (c) 2025 Jongwook Kim, Jangho Park

All rights reserved.

This software and associated documentation files (the "Software") are the 
property of Jongwook Kim and Jangho Park and are protected by copyright law.
...
For permission requests, please contact johnwkim82@gmail.com or jpzawakun@gmail.com.
```

#### 2. Info.plist

`HanguelSkeletypeConverter.glyphsPlugin/Contents/Info.plist` 파일에 저작권 정보가 포함되어 있습니다:

```xml
<key>NSHumanReadableCopyright</key>
<string>Copyright © 2025 Jongwook Kim, Jangho Park. All Rights Reserved.</string>
```

#### 3. plugin.py 헤더

`HanguelSkeletypeConverter.glyphsPlugin/Contents/Resources/plugin.py` 파일 상단에 라이선스 헤더가 포함되어 있습니다:

```python
# encoding: utf-8
"""
Hanguel Skeletype Converter
A Glyphs 3 plugin for extracting centerlines from Korean glyphs.

Copyright (c) 2025 Jongwook Kim, Jangho Park
All Rights Reserved.

This software is the property of Jongwook Kim and Jangho Park and is protected by copyright law.
For permission requests, please contact johnwkim82@gmail.com or jpzawakun@gmail.com.
"""
```
...
`README.md` 파일에 라이선스 섹션이 포함되어 있습니다:
