...
export default function BottomBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 flex justify-center pb-[40px] px-3 pointer-events-none">
      <div className="pointer-events-auto bg-gray-200/90 backdrop-blur-md rounded-full px-4 py-2 flex items-center gap-1 shadow-lg max-w-screen-xl overflow-x-auto scrollbar-hide">
